package com.platform.parent.wxpay;

import com.platform.parent.wxpay.WXPayConstants.SignType;
...
public class WXPay {
    ...
    private WXPay(final WXPayConfig config, SignType signType) throws Exception {
        this(config, null, true, false);
    ...
    public static WXPay getInstance() throws Exception{
        if (INSTANCE == null) {
            synchronized (WXPay.class) {
                if (INSTANCE == null) {
                    INSTANCE = new WXPay(WXPayConfigImpl.getInstance(), WXPayConstants.SignType.MD5);
                }
            }
        }
        return INSTANCE;
...
//        }
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        logger.info("In fillRequestData returning reqData {}", reqData);
        return reqData;
    }
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData,
        ...
        logger.info("In requestWithoutCert, reqBody is {}", reqBody);
    ...
    public Map<String, String> unifiedOrder(Map<String, String> reqData,  int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        Map<String, String> filledReqData = this.fillRequestData(reqData);
        String respXml = this.requestWithoutCert(url, filledReqData, connectTimeoutMs, readTimeoutMs);
        Map<String, String> result = this.processResponseXml(respXml);
        logger.info("In unifiedOrder, before adding paySign, result: {}", result);
        result.put("nonce_str_req", filledReqData.get("nonce_str"));
        result.put("timestamp", filledReqData.get("timeStamp"));
        logger.info("In unifiedOrder, after adding paySign, result: {}", result);
        return result;
    }
    ...
    public Map<String, String> refund(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        // Billy changed requestWithCert to requestWithoutCert on 2018/1/11
        String respXml = this.requestWithCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml);
    }
